...
var createUser = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    var name = _b.name, surname = _b.surname, email = _b.email, password = _b.password;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                if (existingUser) {
                    throw new Error("Ya existe una cuenta con el correo ".concat(email));
                }
            ...
            case 4:
                error_1 = _c.sent();
                throw new Error('Error al crear usuario: ' + error_1);
